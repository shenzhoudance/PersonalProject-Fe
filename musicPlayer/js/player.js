...
// 还没做从数据库删除曲目的功能
// 现在添加歌曲过多歌单会混乱
var deleteMusic = function(n) {
	var list = es('.music-info')
...
var bindEventDel = function() {
	bindAll('.songs .music-delete', 'click', function(event) {
...
var bindEventPage = function() {
	...
	var preBtn = e('#id-pre-page1')
	var nextBtn = e('#id-next-page1')
	var main = e('header')
